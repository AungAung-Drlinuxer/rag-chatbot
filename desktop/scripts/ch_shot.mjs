...
await sleep(6000);
await page.goto("https://chat.drlinuxer.com/#/history", { waitUntil: "networkidle2", timeout: 45000 });
await sleep(5000);
await page.screenshot({ path: "D:/ragchatbot/docs/qa/ch_top.png" });
await page.evaluate(() => {
...
await sleep(1500);
await page.screenshot({ path: "D:/ragchatbot/docs/qa/ch_bottom.png" });
