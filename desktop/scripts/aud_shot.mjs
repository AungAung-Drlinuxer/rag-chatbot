...
await sleep(6000);
await page.goto("https://chat.drlinuxer.com/#/audits", { waitUntil: "networkidle2", timeout: 45000 });
await sleep(5000);
await page.screenshot({ path: "D:/ragchatbot/docs/qa/aud_top.png" });
await page.evaluate(() => {
...
await sleep(1500);
await page.screenshot({ path: "D:/ragchatbot/docs/qa/aud_bottom.png" });
console.log("audits captured");
await browser.close();
