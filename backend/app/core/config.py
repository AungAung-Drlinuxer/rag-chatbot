...
class Settings(BaseSettings):
    ...
    hchat_base_url: str = Field("", validation_alias=AliasChoices("H_CHAT_BASE_URL", "hchat_base_url"))
    hchat_api_key: str = Field("", validation_alias=AliasChoices("H_CHAT_API_KEY", "hchat_api_key"))
    hchat_model: str = Field("claude-4.6", validation_alias=AliasChoices("H_CHAT_MODEL", "hchat_model"))
    hchat_provider: str = Field("anthropic", validation_alias=AliasChoices("H_CHAT_PROVIDER", "hchat_provider"))
