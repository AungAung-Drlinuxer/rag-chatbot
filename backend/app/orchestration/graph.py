...
def _node_classify(state: RAGState) -> dict:
    from app.orchestration import classify_domain
...
def _node_rewrite(state: RAGState) -> dict:
    from app.orchestration.stages import query_rewrite as _query_rewrite
...
def _node_retrieve(state: RAGState) -> dict:
    from app.orchestration.stages import retrieve_stage as _retrieve
...
def _node_gate(state: RAGState) -> dict:
    from app.orchestration.stages import gate_stage as _gate
...
def _node_context(state: RAGState) -> dict:
    from app.orchestration.stages import context_assembly as _context
